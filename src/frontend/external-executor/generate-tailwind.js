// Simple script to generate a Tailwind CSS bundle that mimics CDN behavior
import { writeFileSync } from 'fs';

const tailwindBundle = `
/* Tailwind CSS Bundle - Generated for Bun */
...
/* Utility classes used in the app */
...
.hover\\:bg-red-700:hover { background-color: rgb(185 28 38); }
.gap-3 { gap: 0.75rem; }
.p-3 { padding: 0.75rem; }
...
writeFileSync('./src/frontend/external-executor/tailwind-bundle.css', tailwindBundle);
console.log('Tailwind bundle created!');