    ...
    it('should hide events before abort marker in a turn', () => {
      const events: UnifiedEvent[] = [
        ...
        },
        {
          ...
          event: 3,
          type: 'trace',
          payload: { type: 'turn_aborted', abortedBy: 'agent-a', timestamp: '2024-01-01T00:00:02Z' },
          finality: 'none',
    ...
    it('should not coalesce turn 0 (system events)', () => {
      const events: UnifiedEvent[] = [
        ...
        },
        {
          ...
          event: 2,
          type: 'trace',
          payload: { type: 'turn_aborted', abortedBy: 'system', timestamp: '2024-01-01T00:00:01Z' },
          finality: 'none',
          ts: '2024-01-01T00:00:01Z',
          agentId: 'system',
          seq: 2
    ...
    it('should use last abort marker when multiple exist', () => {
      const events: UnifiedEvent[] = [
        ...
        },
        {
          ...
          event: 2,
          type: 'trace',
          payload: { type: 'turn_aborted', abortedBy: 'agent-a', timestamp: '2024-01-01T00:00:01Z' },
          finality: 'none',
          ts: '2024-01-01T00:00:01Z',
          agentId: 'agent-a',
          seq: 2
        ...
        },
        {
          ...
          event: 4,
          type: 'trace',
          payload: { type: 'turn_aborted', abortedBy: 'agent-a', timestamp: '2024-01-01T00:00:03Z' },
          finality: 'none',
          ts: '2024-01-01T00:00:03Z',
          agentId: 'agent-a',
          seq: 4
    ...
    it('should group coalesced events by turn', () => {
      const events: UnifiedEvent[] = [
        ...
        },
        {
          ...
          event: 2,
          type: 'trace',
          payload: { type: 'turn_aborted', abortedBy: 'agent-b', timestamp: '2024-01-01T00:00:02Z' },
          finality: 'none',
          ts: '2024-01-01T00:00:02Z',
          agentId: 'agent-b',
          seq: 3
